...
--
-- Name: album_volumes; Type: TABLE; Schema: public; Owner: Isa
--

CREATE TABLE album_volumes (
    id integer NOT NULL,
    vote_start date,
    vote_end date,
...
ALTER TABLE album_volumes OWNER TO "Isa";

--
-- Name: album_volumes_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE album_volumes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE album_volumes_id_seq OWNER TO "Isa";

--
-- Name: album_volumes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE album_volumes_id_seq OWNED BY album_volumes.id;


--
-- Name: albums; Type: TABLE; Schema: public; Owner: Isa
--

CREATE TABLE albums (
    id integer NOT NULL,
    name_eng character varying,
    name_kor character varying,
    profile_img text,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    mcountdown character varying
);


ALTER TABLE albums OWNER TO "Isa";

--
-- Name: albums_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE albums_id_seq OWNER TO "Isa";

--
-- Name: albums_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: public; Owner: ollida
--
...
ALTER TABLE ar_internal_metadata OWNER TO ollida;

--
-- Name: artistes; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE artistes OWNER TO "Isa";

--
-- Name: artistes_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE artistes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE artistes_id_seq OWNER TO "Isa";

--
-- Name: artistes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE artistes_id_seq OWNED BY artistes.id;


--
-- Name: awards; Type: TABLE; Schema: public; Owner: ollida
--
...
CREATE TABLE awards (
    ...
    profile_img text,
    judging_criteria hstore DEFAULT ''::hstore NOT NULL,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    masthead_img text,
    description text
...
ALTER TABLE awards OWNER TO ollida;

--
-- Name: awards_id_seq; Type: SEQUENCE; Schema: public; Owner: ollida
--
...
ALTER TABLE awards_id_seq OWNER TO ollida;

--
-- Name: awards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ollida
--
...
--
-- Name: carts; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE carts OWNER TO "Isa";

--
-- Name: carts_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE carts_id_seq OWNER TO "Isa";

--
-- Name: carts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: digital_sales; Type: TABLE; Schema: public; Owner: Isa
--
...
CREATE TABLE digital_sales (
    ...
    artiste_id integer,
    song_id integer,
    download_cnt double precision,
    stream_cnt double precision,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);


ALTER TABLE digital_sales OWNER TO "Isa";

--
-- Name: digital_sales_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE digital_sales_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE digital_sales_id_seq OWNER TO "Isa";

--
-- Name: digital_sales_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE digital_sales_id_seq OWNED BY digital_sales.id;


--
-- Name: digital_service_providers; Type: TABLE; Schema: public; Owner: Isa
--

CREATE TABLE digital_service_providers (
    id integer NOT NULL,
    name character varying,
    profile_img text,
    home_url text
...
ALTER TABLE digital_service_providers OWNER TO "Isa";

--
-- Name: digital_service_providers_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE digital_service_providers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE digital_service_providers_id_seq OWNER TO "Isa";

--
-- Name: digital_service_providers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE digital_service_providers_id_seq OWNED BY digital_service_providers.id;


--
-- Name: digital_service_providers_links; Type: TABLE; Schema: public; Owner: Isa
--

CREATE TABLE digital_service_providers_links (
    id integer NOT NULL,
    song_id integer,
    digital_service_provider_id integer,
    link text,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
ALTER TABLE digital_service_providers_links OWNER TO "Isa";

--
-- Name: digital_service_providers_links_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE digital_service_providers_links_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE digital_service_providers_links_id_seq OWNER TO "Isa";

--
-- Name: digital_service_providers_links_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE digital_service_providers_links_id_seq OWNED BY digital_service_providers_links.id;


--
-- Name: films; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE films OWNER TO "Isa";

--
-- Name: line_items; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE line_items OWNER TO "Isa";

--
-- Name: line_items_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE line_items_id_seq OWNER TO "Isa";

--
-- Name: line_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: mcountdown_rankings; Type: TABLE; Schema: public; Owner: Isa
--

CREATE TABLE mcountdown_rankings (
    id integer NOT NULL,
    nominee_id integer,
    mcountdown_votes double precision,
    normalized_mv double precision,
    youtube_views double precision,
    normalized_yv double precision,
    download_cnt double precision,
    stream_cnt double precision,
    normalized_ds double precision,
...
ALTER TABLE mcountdown_rankings OWNER TO "Isa";

--
-- Name: mcountdown_rankings_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE mcountdown_rankings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE mcountdown_rankings_id_seq OWNER TO "Isa";

--
-- Name: mcountdown_rankings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE mcountdown_rankings_id_seq OWNED BY mcountdown_rankings.id;


--
-- Name: mcountdown_votes; Type: TABLE; Schema: public; Owner: Isa
--

CREATE TABLE mcountdown_votes (
    id integer NOT NULL,
    date_d date,
    artiste_id integer,
    song_id integer,
...
ALTER TABLE mcountdown_votes OWNER TO "Isa";

--
-- Name: mcountdown_votes_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE mcountdown_votes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE mcountdown_votes_id_seq OWNER TO "Isa";

--
-- Name: mcountdown_votes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE mcountdown_votes_id_seq OWNED BY mcountdown_votes.id;


--
-- Name: nomination_cycles; Type: TABLE; Schema: public; Owner: Isa
--
...
CREATE TABLE nomination_cycles (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    ranking_present boolean DEFAULT false
);


ALTER TABLE nomination_cycles OWNER TO "Isa";

--
-- Name: nomination_cycles_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE nomination_cycles_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE nomination_cycles_id_seq OWNER TO "Isa";

--
-- Name: nomination_cycles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE nomination_cycles_id_seq OWNED BY nomination_cycles.id;


--
-- Name: nominees; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE nominees OWNER TO "Isa";

--
-- Name: nominees_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE nominees_id_seq OWNER TO "Isa";

--
-- Name: nominees_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: order_statuses; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE order_statuses OWNER TO "Isa";

--
-- Name: order_statuses_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE order_statuses_id_seq OWNER TO "Isa";

--
-- Name: order_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: products; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE products OWNER TO "Isa";

--
-- Name: products_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE products_id_seq OWNER TO "Isa";

--
-- Name: products_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: public; Owner: ollida
--
...
ALTER TABLE schema_migrations OWNER TO ollida;

--
-- Name: songs; Type: TABLE; Schema: public; Owner: Isa
--
...
CREATE TABLE songs (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    melon character varying,
    bugs character varying,
    genie character varying
);


ALTER TABLE songs OWNER TO "Isa";

--
-- Name: songs_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE songs_id_seq OWNER TO "Isa";

--
-- Name: songs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: ollida
--
...
ALTER TABLE users OWNER TO ollida;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: ollida
--
...
ALTER TABLE users_id_seq OWNER TO ollida;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ollida
--
...
--
-- Name: youtube_videos; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE youtube_videos OWNER TO "Isa";

--
-- Name: youtube_videos_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--
...
ALTER TABLE youtube_videos_id_seq OWNER TO "Isa";

--
-- Name: youtube_videos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--
...
--
-- Name: youtube_views; Type: TABLE; Schema: public; Owner: Isa
--
...
ALTER TABLE youtube_views OWNER TO "Isa";

--
-- Name: youtube_views_id_seq; Type: SEQUENCE; Schema: public; Owner: Isa
--

CREATE SEQUENCE youtube_views_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE youtube_views_id_seq OWNER TO "Isa";

--
-- Name: youtube_views_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Isa
--

ALTER SEQUENCE youtube_views_id_seq OWNED BY youtube_views.id;


--
-- Name: id; Type: DEFAULT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY album_volumes ALTER COLUMN id SET DEFAULT nextval('album_volumes_id_seq'::regclass);
...
ALTER TABLE ONLY artistes ALTER COLUMN id SET DEFAULT nextval('artistes_id_seq'::regclass);


--
-- Name: id; Type: DEFAULT; Schema: public; Owner: ollida
--
...
ALTER TABLE ONLY digital_sales ALTER COLUMN id SET DEFAULT nextval('digital_sales_id_seq'::regclass);
...
ALTER TABLE ONLY digital_service_providers ALTER COLUMN id SET DEFAULT nextval('digital_service_providers_id_seq'::regclass);
...
ALTER TABLE ONLY digital_service_providers_links ALTER COLUMN id SET DEFAULT nextval('digital_service_providers_links_id_seq'::regclass);
...
ALTER TABLE ONLY mcountdown_rankings ALTER COLUMN id SET DEFAULT nextval('mcountdown_rankings_id_seq'::regclass);
...
ALTER TABLE ONLY mcountdown_votes ALTER COLUMN id SET DEFAULT nextval('mcountdown_votes_id_seq'::regclass);
...
ALTER TABLE ONLY nomination_cycles ALTER COLUMN id SET DEFAULT nextval('nomination_cycles_id_seq'::regclass);
...
ALTER TABLE ONLY youtube_views ALTER COLUMN id SET DEFAULT nextval('youtube_views_id_seq'::regclass);
...
--
-- Name: album_volumes_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY album_volumes
    ADD CONSTRAINT album_volumes_pkey PRIMARY KEY (id);


--
-- Name: albums_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: ollida
--
...
--
-- Name: artistes_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: awards_pkey; Type: CONSTRAINT; Schema: public; Owner: ollida
--
...
--
-- Name: carts_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: digital_sales_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY digital_sales
    ADD CONSTRAINT digital_sales_pkey PRIMARY KEY (id);


--
-- Name: digital_service_providers_links_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY digital_service_providers_links
    ADD CONSTRAINT digital_service_providers_links_pkey PRIMARY KEY (id);


--
-- Name: digital_service_providers_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY digital_service_providers
    ADD CONSTRAINT digital_service_providers_pkey PRIMARY KEY (id);


--
-- Name: films_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: line_items_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: mcountdown_rankings_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY mcountdown_rankings
    ADD CONSTRAINT mcountdown_rankings_pkey PRIMARY KEY (id);


--
-- Name: mcountdown_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY mcountdown_votes
    ADD CONSTRAINT mcountdown_votes_pkey PRIMARY KEY (id);


--
-- Name: nomination_cycles_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY nomination_cycles
    ADD CONSTRAINT nomination_cycles_pkey PRIMARY KEY (id);


--
-- Name: nominees_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: order_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: products_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: schema_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: ollida
--
...
--
-- Name: songs_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: users_pkey; Type: CONSTRAINT; Schema: public; Owner: ollida
--
...
--
-- Name: youtube_videos_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--
...
--
-- Name: youtube_views_pkey; Type: CONSTRAINT; Schema: public; Owner: Isa
--

ALTER TABLE ONLY youtube_views
    ADD CONSTRAINT youtube_views_pkey PRIMARY KEY (id);


--
-- Name: id_idx; Type: INDEX; Schema: public; Owner: Isa
--

CREATE UNIQUE INDEX id_idx ON songs USING btree (id);


--
-- Name: index_users_on_email; Type: INDEX; Schema: public; Owner: ollida
--
...
--
-- Name: index_users_on_fb_uid; Type: INDEX; Schema: public; Owner: ollida
--

CREATE INDEX index_users_on_fb_uid ON users USING btree (fb_uid);


--
-- Name: index_users_on_reset_password_token; Type: INDEX; Schema: public; Owner: ollida
--
...
--
-- Name: public; Type: ACL; Schema: -; Owner: Isa
--

REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM "Isa";
GRANT ALL ON SCHEMA public TO "Isa";
GRANT ALL ON SCHEMA public TO PUBLIC;


--
-- Name: album_volumes; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE album_volumes FROM PUBLIC;
REVOKE ALL ON TABLE album_volumes FROM "Isa";
GRANT ALL ON TABLE album_volumes TO "Isa";
GRANT ALL ON TABLE album_volumes TO ollida;


--
-- Name: albums; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE albums FROM PUBLIC;
REVOKE ALL ON TABLE albums FROM "Isa";
GRANT ALL ON TABLE albums TO "Isa";
GRANT ALL ON TABLE albums TO ollida;


--
-- Name: ar_internal_metadata; Type: ACL; Schema: public; Owner: ollida
--

REVOKE ALL ON TABLE ar_internal_metadata FROM PUBLIC;
REVOKE ALL ON TABLE ar_internal_metadata FROM ollida;
GRANT ALL ON TABLE ar_internal_metadata TO ollida;


--
-- Name: artistes; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE artistes FROM PUBLIC;
REVOKE ALL ON TABLE artistes FROM "Isa";
GRANT ALL ON TABLE artistes TO "Isa";
GRANT ALL ON TABLE artistes TO ollida;


--
-- Name: awards; Type: ACL; Schema: public; Owner: ollida
--

REVOKE ALL ON TABLE awards FROM PUBLIC;
REVOKE ALL ON TABLE awards FROM ollida;
GRANT ALL ON TABLE awards TO ollida;


--
-- Name: digital_sales; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE digital_sales FROM PUBLIC;
REVOKE ALL ON TABLE digital_sales FROM "Isa";
GRANT ALL ON TABLE digital_sales TO "Isa";
GRANT ALL ON TABLE digital_sales TO ollida;


--
-- Name: digital_service_providers; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE digital_service_providers FROM PUBLIC;
REVOKE ALL ON TABLE digital_service_providers FROM "Isa";
GRANT ALL ON TABLE digital_service_providers TO "Isa";
GRANT ALL ON TABLE digital_service_providers TO ollida;


--
-- Name: mcountdown_rankings; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE mcountdown_rankings FROM PUBLIC;
REVOKE ALL ON TABLE mcountdown_rankings FROM "Isa";
GRANT ALL ON TABLE mcountdown_rankings TO "Isa";
GRANT ALL ON TABLE mcountdown_rankings TO ollida;


--
-- Name: mcountdown_votes; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE mcountdown_votes FROM PUBLIC;
REVOKE ALL ON TABLE mcountdown_votes FROM "Isa";
GRANT ALL ON TABLE mcountdown_votes TO "Isa";
GRANT ALL ON TABLE mcountdown_votes TO ollida;


--
-- Name: nomination_cycles; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE nomination_cycles FROM PUBLIC;
REVOKE ALL ON TABLE nomination_cycles FROM "Isa";
GRANT ALL ON TABLE nomination_cycles TO "Isa";
GRANT ALL ON TABLE nomination_cycles TO ollida;


--
-- Name: nominees; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE nominees FROM PUBLIC;
REVOKE ALL ON TABLE nominees FROM "Isa";
GRANT ALL ON TABLE nominees TO "Isa";
GRANT ALL ON TABLE nominees TO ollida;


--
-- Name: schema_migrations; Type: ACL; Schema: public; Owner: ollida
--

REVOKE ALL ON TABLE schema_migrations FROM PUBLIC;
REVOKE ALL ON TABLE schema_migrations FROM ollida;
GRANT ALL ON TABLE schema_migrations TO ollida;


--
-- Name: songs; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE songs FROM PUBLIC;
REVOKE ALL ON TABLE songs FROM "Isa";
GRANT ALL ON TABLE songs TO "Isa";
GRANT ALL ON TABLE songs TO ollida;


--
-- Name: users; Type: ACL; Schema: public; Owner: ollida
--

REVOKE ALL ON TABLE users FROM PUBLIC;
REVOKE ALL ON TABLE users FROM ollida;
GRANT ALL ON TABLE users TO ollida;


--
-- Name: youtube_videos; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE youtube_videos FROM PUBLIC;
REVOKE ALL ON TABLE youtube_videos FROM "Isa";
GRANT ALL ON TABLE youtube_videos TO "Isa";
GRANT ALL ON TABLE youtube_videos TO ollida;


--
-- Name: youtube_views; Type: ACL; Schema: public; Owner: Isa
--

REVOKE ALL ON TABLE youtube_views FROM PUBLIC;
REVOKE ALL ON TABLE youtube_views FROM "Isa";
GRANT ALL ON TABLE youtube_views TO "Isa";
GRANT ALL ON TABLE youtube_views TO ollida;
